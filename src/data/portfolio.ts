...
export const PORTFOLIO_DATA = {
  ...
  skills: [
    ...
    { name: "Spring Boot", level: 88, category: "Backend", color: "#6DB33F", icon: "🌱" },
    { name: "Java", level: 90, category: "Backend", color: "#F89820", icon: "☕" },
    { name: "React.js", level: 82, category: "Frontend", color: "#61DAFB", icon: "⚛️" },
    { name: "REST APIs", level: 80, category: "Backend", color: "#7F5AF0", icon: "🔌" },
    ...
    { name: "IntelliJ IDEA", level: 84, category: "Tools", color: "#F05032", icon: "🔀" },
